...
const OwnerNotificationDetailModal = ({ notification, onClose, onDelete }) => {
      ...
      case 'booking':
        return (
          <div className="space-y-3">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 border-b border-gray-100 gap-1">
              <span className="text-gray-600 text-xs sm:text-sm flex-shrink-0">Customer</span>
              <span className="text-gray-900 font-medium text-xs sm:text-sm break-words">
...
export default OwnerNotificationDetailModal;
