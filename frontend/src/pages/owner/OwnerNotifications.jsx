...
import OwnerNotificationTabs from '../../components/ownerNotifications/OwnerNotificationTabs';
import OwnerNotificationContainer from '../../components/ownerNotifications/OwnerNotificationContainer';
import OwnerNotificationDetailModal from '../../components/ownerNotifications/OwnerNotificationDetailModal';
  ...
  const fetchNotifications = async () => {
    ...
    try {
      ...
      if (notificationsList.length > 0) {
        // Filter notifications to show only owner-related ones
        // Owner sees: booking requests, reviews, booking confirmations, status updates
        const ownerNotifications = notificationsList.filter(n => 
          n.type && (
            ...
            n.type.toLowerCase() === 'success'
          )
        );
        setNotifications(ownerNotifications);
        updateCounts(ownerNotifications);
      } else {
      ...
      <div className="min-h-screen bg-gray-50 pb-20">
        ...
        <div className="bg-white sticky top-16 z-40">
          <div className="max-w-7xl mx-auto px-6">
            <OwnerNotificationTabs activeTab={activeTab} onTabChange={setActiveTab} counts={counts} />
          </div>
        </div>
